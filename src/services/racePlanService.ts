...
// generateRacePlanDraft/persistRacePlan below mirror fatLossPlanService.ts's
// generateFatLossPlan/persistFatLossPlan split, for a generate → review →
// regenerate → lock flow.
